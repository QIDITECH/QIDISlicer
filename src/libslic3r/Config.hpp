...
// When parsing a configuration value, if the old_value is not understood by this QIDISlicer version,
// it is being substituted with some default value that this QIDISlicer could work with.
