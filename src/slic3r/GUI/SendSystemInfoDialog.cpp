...
static const std::string SEND_SYSTEM_INFO_DOMAIN = "qidi3d.com";
...
static bool should_dialog_be_shown()
{
    ...
    // https://forum.qidiprinters.org/forum/qidislicer/qidislicer-2-4-0-beta1-is-out/#post-518488.
...
// Following function saves current QIDISlicer version into app config.
...
static std::string generate_system_info_json()
{
    ...
    pt::ptree data_node;
    data_node.put("QIDISlicerVersion", SLIC3R_VERSION);
           ...
           wxDEFAULT_DIALOG_STYLE)
{
    ...
    wxString text2 = GUI::format_wxstr(
        _L("We do not send any personal information nor anything that would allow us "
           ...
           "installation are sent. QIDISlicer is open source, if you want to "
    ...
    wxString html = GUI::format_wxstr(
            ...
            "<table><tr><td>"
            "<img src = \"" + resources_dir() + "/icons/QIDISlicer_192px.png\" />"
            "</td><td align=\"left\">"
            + text0 + "<br / ><br / >"
            + text1 + "<br /><br />"
            "</td></tr></table>"
