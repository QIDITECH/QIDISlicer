...
void GLGizmoCut3D::render_shortcuts()
{
    ...
    if (m_show_shortcuts)
        for (const auto&shortcut : m_shortcuts ){
            ImGuiPureWrap::text_colored(ImGuiPureWrap::COL_BLUE_LIGHT, shortcut.first);
...
void GLGizmoCut3D::render_build_size()
{
    ...
    ImGui::SameLine();
    ImGuiPureWrap::text_colored(ImGuiPureWrap::COL_BLUE_LIGHT, size);
}
...
//    if (m_mode == size_t(CutMode::cutPlanar)) {
    ...
    if (mode == CutMode::cutPlanar || mode == CutMode::cutTongueAndGroove) {
        ...
        ImGui::SameLine();
        ImGuiPureWrap::text_colored(ImGuiPureWrap::COL_BLUE_LIGHT,
...
//        render_flip_plane_button();
        ...
        if (mode == CutMode::cutPlanar) {
            ...
            ImGui::Separator();
            ImGuiPureWrap::text_colored(ImGuiPureWrap::COL_BLUE_LIGHT, m_labels_map["Groove"] + ": ");
